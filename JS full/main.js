// JS - JavaScript, это полноценный динамический язык программирования
...
//!  ==	equal to (проверяет только значения) "5" == 5 => true
//!  ===    (равное значение и равный тип) equal value and equal type "5" === 5 => false
//!  !=	not equal
